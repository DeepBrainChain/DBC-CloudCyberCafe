...
def edit_ipxe_cfg(config_folder, mac_addr, initiator_iqn, iscsi_target_prefix, boot_menu,
  ...
  with open(f'{config_folder}/mac-{mac_addr}.ipxe.cfg', 'w', encoding='utf-8') as file:
    ...
    file.write(f'set initiator-iqn {iscsi_target_prefix}:sn.{default_menu}')
    if manager:
      file.write(f'\n')
    else:
    ...
    if manager:
      ...
      file.write('initrd ${base-url}/winpe/lightningWinPE/boot/bcd            BCD\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/boot/boot.sdi       boot.sdi\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/sources/BOOT.WIM    boot.wim\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/bootmgr             bootmgr\n')
      ...
      file.write('initrd ${base-url}/winpe/lightningWinPE/efi/boot/bootx64.efi      bootx64.efi\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/efi/microsoft/boot/bcd    BCD\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/boot/boot.sdi             boot.sdi\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/sources/BOOT.WIM          boot.wim\n')
      file.write('initrd ${base-url}/winpe/lightningWinPE/bootmgr.efi               bootmgr\n')
      file.write('echo Starting the system....\n')
      file.write('boot || goto failed\n')
      file.write('goto start\n')
      file.write('\n')
